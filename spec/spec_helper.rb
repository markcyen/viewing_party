...
def list_top_40_stub
  response_body_1 = File.read('spec/fixtures/top_movies_1.json')
  response_body_2 = File.read('spec/fixtures/top_movies_2.json')
...
def list_godfather_search_stub
  response_body_1 = File.read('spec/fixtures/search_movies_1.json')
  response_body_2 = File.read('spec/fixtures/search_movies_2.json')

  stub_request(:get, "https://api.themoviedb.org/3/search/movie?api_key=#{ENV['api_key']}&language=en-US&page=1&query=godfather").
    to_return(status: 200, body: response_body_1, headers: {})
